def get_label(label):
    ...
    diseases = [
        ...
        },
        {
            ...
            "treatment": "Se propaga fácilmente al usar material vegetal infectado. Del mismo modo, su estabilidad le permite ser transmitido a través de implementos usados en labores agrícolas. Otra vector de transmisión es la mosca blanca.",
            "recommendation": [
